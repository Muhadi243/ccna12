...
(lib.ID_txt05 = function() {
	...
	// ID_txt05
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt05",width:"40",expand:"up+down",align:"center",color:"#652c8a",bold:"1"});
...
(lib.ID_txt04 = function() {
	...
	// ID_txt04
	this.text= new DOMObject({type:"TEXT",compId:"ID_txt04",width:"40",expand:"up+down",align:"center",color:"#652c8a",bold:"1"});	
	this.text.setTransform(25,5);
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
...
(lib.text4 = function() {
	...
	// ID_txt09
	this.text = new TextBoxComp({width:120,height:180,titleId:"",bodyId:"ID_txt09",size:"11",divId:"textBox4"});
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
...
(lib.text3 = function() {
	...
	// ID_txt08
	this.text = new TextBoxComp({width:120,height:180,titleId:"",bodyId:"ID_txt08",size:"11",divId:"textBox3"});
...
(lib.text2 = function() {
	...
	// ID_txt07
	this.text = new TextBoxComp({width:120,height:180,titleId:"",bodyId:"ID_txt07",size:"11",divId:"textBox2"});
...
(lib.text1 = function() {
	...
	// ID_txt06
	this.text = new TextBoxComp({width:120,height:180,titleId:"",bodyId:"ID_txt06",size:"11",divId:"textBox1"});
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_39.setTransform(551.5,178.5,1,1,0,0,0,88.5,8.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_39).wait(183).to({alpha:0},0).wait(399));

	// textbox2
	this.instance_40 = new lib.text2();
	this.instance_40.setTransform(551.5,178.5,1,1,0,0,0,88.5,8.5);
	...
	this.instance_41.setTransform(551.5,178.5,1,1,0,0,0,88.5,8.5);
	...
	this.instance_42.setTransform(551.5,178.5,1,1,0,0,0,88.5,8.5);
